"""autogenerated by genpy from Rover5_ROS/rover_out.msg. Do not edit."""
import sys
...
# used to pass variables from the Rover5 platform to the ROS environment  
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(rover_out, self).__init__(*args, **kwds)
